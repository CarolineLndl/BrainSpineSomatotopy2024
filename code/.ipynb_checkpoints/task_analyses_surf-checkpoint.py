    ...
    def plot_outlines(self, movements=None, threshold=5):
        ...
        for mov in movements:
            ...
            for hemi in ['left','right']:
                ...
                plot = nlp.plot_surf_roi(self.brain_surfaces + ('lh.inflated' if hemi == 'left' else 'rh.inflated'), roi_map=task_surf_bin, hemi=hemi, view='lateral', cmap="binary",threshold=2,bg_map=self.brain_surfaces + ('lh.sulc' if hemi == 'left' else 'rh.sulc'),  colorbar=True, darkness=0.7,vmax=1) #,
